...
import { ArrowLeft, Save, Settings, LogOut, AlertTriangle } from "lucide-react";
...
export function SettingsPage({ onBack }: SettingsPageProps) {
	...
	const { apiSettings, saveApiSettings, isApiConfigured } = useApi();
				...
				<div className="max-w-md mx-auto space-y-6">
							...
							<div className="flex items-start gap-3">
								...
								<div>
									...
									<p className="text-sm text-amber-700 dark:text-amber-300 mt-1">
										Please configure your API URL and token to use the
										extension. The extension will automatically redirect here
										when these settings are missing.
									</p>
								</div>
							</div>
						</div>
					...
					<div className="space-y-2">
						...
						<input
							id="api-url"
							type="text"
							placeholder="https://yt-audio-summary.pcarion.workers.dev"
